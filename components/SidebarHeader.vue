<template>
    <div
      class="-mt-10 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 pt-3 md:pt-0 mb-10"
    >
      <div class="top-bar-boxed flex items-center justify-between mx-4">
        <div class="flex items-center">
          <div class="text-blue-700">User Profile</div>
        </div>
        <!-- <div class="intro-x dropdown mr-4 sm:mr-6 text-white"> -->
        <div class="flex items-center">
            <div class=" pr-3 text-black" v-html="clockIcon"></div>
            <div class=" pr-5 text-black">{{ currentTime }}</div>
            <div class=" pr-3 text-black cursor-pointer" v-html="bellIcon"></div>
          ...
          <transition name="ease-in">
            <template v-if="isProfileMenuOpen">
              <div
                ...
                class="dropdown-menu w-56 absolute right-0"
              ...
              >
                ...
                >
                  ...
                  <div class="p-2">
                    ...
                    <a
                      href=""
                      class="flex items-center  p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md hidden"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"

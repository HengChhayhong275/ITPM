  ...
  <div class="h-screen bg-white flex items-center">
    <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
      <div class="max-w-md">
        ...
        <a class="bg-brand-500 hover:bg-brand-600 text-white py-3 px-6 rounded-full shadow-xl transform duration-300 hover:-translate-y-1"
          :href="localePath('/')">
          {{ $t('errorPage.backToHomepage') }}
        </a>
      </div>
      <div class="max-w-lg">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2395 1800" width="400">
          <defs>
            <style>
              .cls-1 {
                fill: #d6b49a;
